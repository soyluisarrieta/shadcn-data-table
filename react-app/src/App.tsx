  ...
  return (
    <main>
      <section className="container-wrapper py-20 flex flex-col items-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-950 to-neutral-700 dark:from-neutral-50 dark:to-neutral-400 bg-opacity-50">
          Shadcn Data Table
        </h1>
      ...
      <section>
        ...
        <div className="container-wrapper p-3 md:p-6">
